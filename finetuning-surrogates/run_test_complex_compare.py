...
class Thinker(BaseThinker):
    ...
    def __init__(
        ...
        rec = ResourceCounter(n_qc_workers * 2, ['sample', 'simulate'])
        ...
        self.rec.reallocate(None, 'simulate', n_qc_workers)  # Start with all devoted to sampling
...
if __name__ == '__main__':
    ...
    if not os.path.exists('/tmp/psi4'):
        os.mkdir('/tmp/psi4')
    my_run_simulation = _wrap(run_calculator, calc=calc, temp_path='/tmp/psi4', cpu=8)
