    ...
    config = Config(
        ...
        executors=[
            HighThroughputExecutor(
                ...
                provider=AdHocProvider(
                    channels=[SSHChannel(hostname='rtxgpu005',port='22', username='cse30019698', password='Yxx!199871!', script_dir='/home/lizz_lab/cse30019698/parsl-logs')],
                    worker_init='''
                    # Activate conda environment
            ...
            HighThroughputExecutor(
                ...
                worker_logdir_root='/home/lizz_lab/cse30019698/parsl-logs',
                provider=AdHocProvider(
                    channels=[SSHChannel(hostname='rtxgpu005', port='10022', username='cse30019698', password='Yxx!199871!', script_dir='/home/lizz_lab/cse30019698/parsl-logs')],
                    worker_init='''
                    # Activate conda environment
                    source /home/lizz_lab/cse30019698/software/miniconda3/bin/activate /home/lizz_lab/cse30019698/software/miniconda3/envs/multisite
                    export CUDA_VISIBLE_DEVICES=0,1,2,3
